...
```
{
  ...
  panelFilter: { orange: true, green: false, lightBlue: false, yellow: false, red: false }  // FR-010 default
}
```
...
- Color severity ordering for badge: [spec.md](./spec.md) FR-028 (orange > red > yellow).
