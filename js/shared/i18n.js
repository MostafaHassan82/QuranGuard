...
const QuranI18n = (() => {
  const CATALOGS = {
    ar: {
      ...
      // popup
      popup_title: 'صَوْنُ القُرآن',
      popup_title_a: 'صَوْنُ',
      popup_title_b: 'القُرآن',
      scan_mode: 'وضع الفحص:',
      manual: 'يدوي',
      auto: 'تلقائي',
      ...
      options_heading_a: 'الإ',
      options_heading_b: 'عدادات',
      sec_appearance: 'المظهر',
      appearance_heading: 'اختيار المظهر',
      appearance_hint: 'يُطبَّق المظهر فورًا على النافذة المنبثقة وصفحة الإعدادات واللوحة الجانبية.',
      appearance_picker_aria: 'اختر مظهرًا',
      theme_default_name: 'الافتراضي',
      theme_default_desc: 'الواجهة القياسية — أقل زخرفة، أعلى تباين',
      theme_mihrab_name: 'المحراب',
      theme_mihrab_desc: 'قَوس المحراب وخط الأميري وتفاصيل ذهبية',
      theme_atelier_name: 'الأتلييه',
      theme_atelier_desc: 'مخطوطة على رَقّ — حِبر ومداد ذهبي بنكهة متحفية',
      theme_diwan_name: 'الديوان',
      theme_diwan_desc: 'حداثة ناعمة — انحناءات مستديرة، نُعناع باهت، وفسحة مريحة',
      theme_marakeb_name: 'المراكب',
      theme_marakeb_desc: 'طرفيّة داكنة — أخضر فُسفوري على فحمي بخط برمجي',
      theme_tahrir_name: 'التحرير',
      theme_tahrir_desc: 'صحيفة عربية — رؤوس ثقيلة، تباين عالٍ، أخضر كلمسة وحيدة',
      sec_language: 'اللغة',
      ...
      autocorrect_yellow_hint: 'يستبدل النص المكتوب بنص المصحف الأصلي في الصفحة عند كل فحص.',
      autocorrect_red: 'قبول أقرب آية للنصوص غير الموجودة (الأحمر) تلقائيًا',
      autocorrect_red_hint: 'يستبدل النص الذي لم يُعثر عليه بأقرب آية يقترحها المحقّق — فقط حين يوجد اقتراح وحيد. خيار عالي المخاطرة.',
      ...
      sidebar_title_a: 'نتائج',
      sidebar_title_b: 'التحقق',
      collapse: 'طيّ',
      ...
      ac_max_candidates: 'أقصى عدد للاقتراحات المعروضة:',
      ac_max_candidates_unlimited: 'بدون حد',
      ac_multi_ayahs_cap: 'الحد الأقصى لكلمات الإدراج متعدد الآيات:',
      ac_multi_ayahs_hint: 'يرفض الإدراج إذا تجاوز عدد الكلمات هذا الحد (لمنع إدراج سور طويلة كالبقرة).',
      ac_scope_whole: 'الآية كاملة',
      ac_scope_typed: 'ما كتبتَه فقط',
      ac_scope_endword: 'إلى…',
      ac_endword_prompt: 'اكتب كلمة (أو كلمات) النهاية',
      ac_endword_not_found: 'لم يُعثر على كلمة (أو كلمات) النهاية في الآية.',
      ac_scope_multi_ayahs: 'عدّة آيات…',
      ac_scope_surah_end: 'إلى نهاية السورة',
      ac_multi_ayahs_prompt: 'كم آية تريد إدراجها؟',
      ac_multi_ayahs_min: 'أدخل عددًا 2 أو أكثر.',
      ac_cap_exceeded: 'يتجاوز الحد الأقصى للإدراج ({cap} كلمة).',
    ...
    en: {
      ...
      options_heading_a: 'Sett',
      options_heading_b: 'ings',
      sec_appearance: 'Appearance',
      appearance_heading: 'Choose a theme',
      appearance_hint: 'The chosen theme applies immediately to the popup, options page, and sidebar.',
      appearance_picker_aria: 'Choose a theme',
      theme_default_name: 'Default',
      theme_default_desc: 'Standard UI — minimal ornament, high contrast',
      theme_mihrab_name: 'Mihrab',
      theme_mihrab_desc: 'Arched headers, Amiri script, gold detailing',
      theme_atelier_name: 'Atelier',
      theme_atelier_desc: 'Editorial manuscript — parchment, ink, restrained gold leaf',
      theme_diwan_name: 'Diwan',
      theme_diwan_desc: 'Soft modern — rounded corners, mint pastels, generous whitespace',
      theme_marakeb_name: 'Marakeb',
      theme_marakeb_desc: 'Terminal — phosphor green on near-black, monospace throughout',
      theme_tahrir_name: 'Tahrir',
      theme_tahrir_desc: 'Arabic broadsheet — heavy mastheads, high contrast, single green accent',
      ...
      autocorrect_yellow_hint: 'Replaces the written text with the authentic mushaf wording on the page on every scan.',
      autocorrect_red: 'Auto-accept the nearest ayah for unmatched text (red)',
      autocorrect_red_hint: 'Replaces text that was not found with the verifier\'s nearest ayah — only when a single suggestion exists. High-risk option.',
      ...
      sidebar_title_a: 'Verification',
      sidebar_title_b: 'results',
      collapse: 'Collapse',
      ...
      ac_max_candidates: 'Max suggestions to show:',
      ac_max_candidates_unlimited: 'Unlimited',
      ac_multi_ayahs_cap: 'Word cap for multi-ayah insertion:',
      ac_multi_ayahs_hint: 'Refuses the insert if the resulting word count exceeds this cap (prevents pasting long surahs like al-Baqarah).',
      ac_scope_whole: 'Whole ayah',
      ac_scope_typed: 'Only what I typed',
      ac_scope_endword: 'Up to…',
      ac_endword_prompt: 'Type the ending word(s)',
      ac_endword_not_found: 'Ending word(s) not found in the ayah.',
      ac_scope_multi_ayahs: 'Multiple ayahs…',
      ac_scope_surah_end: 'To the end of the surah',
      ac_multi_ayahs_prompt: 'How many ayahs?',
      ac_multi_ayahs_min: 'Enter a number 2 or greater.',
      ac_cap_exceeded: 'Exceeds the insertion cap ({cap} words).',
