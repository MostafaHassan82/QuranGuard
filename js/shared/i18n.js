...
const QuranI18n = (() => {
  const CATALOGS = {
    ar: {
      ...
      ac_multi_ayahs_count: 'عدد الآيات في خيار "آيات متعددة":',
    ...
    en: {
      ...
      ac_multi_ayahs_count: 'Number of ayahs for the "N ayahs" option:',
